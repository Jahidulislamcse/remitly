...
<div class="row">
    <div class="col-md-4">
        <div class="card">
            <div class="card-body">
                <form
                    action="@if(empty($id)) {{ route('announce') }} @else {{ route('announce.edit',$id) }}  @endif"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"
                                    value="{{ old('title', @$data->title)}}" name="title">
                            </div>

                            <div class="form-group">
                                <label> {{ __("Content") }} <span style="color:red">*</span></label>
                                <textarea c{{ __("") }}lass="ckeditor" data="0"
                                    name="content">{{ old('title', @$data->content)}}</textarea>
                            </div>
                ...
                <table id="myTable" class="table table-striped table-bordered ">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center; ">{!! str($li->content)->limit(150) !!}</td>
                            <td style="text-align: center;">


                                <a href="{{ route('announce.edit',$li->id) }}" style="margin: 15px" title="Edit">
                                ...
                                <span data="{{ route('announce.delete',$li->id) }}" class="delete-btn">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
