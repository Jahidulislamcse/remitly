        ...
        <div class="container">
            <div class="account-form">
                <div class="d-flex gap-2 justify-content-between mb-4">
                    ...
                    @if (gs('qrcode_login'))
                        <x-qrcodelogin :qrCode="$qrCode" guard="merchant" />
                    @endif
                </div>
                ...
                <form method="POST" action="{{ route('merchant.login') }}" class="verify-gcaptcha">
                    @csrf
                    ...
                    <div class="mb-3">
                        <button type="submit" class="btn btn--grbtn w-100">
                            @lang('user.login') <i class="fa fa-angle-right"></i>
                        </button>
                    </div>
                    <div class="mb-3">
                        @lang('Don’t have an account?') <a href="{{ route('merchant.register') }}"
